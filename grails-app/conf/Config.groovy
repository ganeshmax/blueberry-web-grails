...
grails.project.groupId = "com.blueberry" // change this to alter the default package name and Maven publishing destination
...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'com.blueberry.User'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'com.blueberry.UserRole'
grails.plugin.springsecurity.authority.className = 'com.blueberry.Role'
